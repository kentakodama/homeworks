...
exports.fetchSearchGiphys = exports.requestSearchGiphys = exports.receiveSearchGiphys = exports.REQUEST_SEARCH_GIPHYS = exports.RECEIVE_SEARCH_GIPHYS = undefined;
...
var requestSearchGiphys = exports.requestSearchGiphys = function requestSearchGiphys(giphys) {
  return {
...
var GiphysReducer = exports.GiphysReducer = function GiphysReducer() {
  ...
  switch (action.type) {
    case _giphy_actions.RECEIVE_SEARCH_GIPHYS:
      nextState = [].concat(_toConsumableArray(state), [action.giphys]);
      return nextState;
    default:
      return state;
  }
